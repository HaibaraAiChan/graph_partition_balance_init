...
from load_graph import load_reddit, inductive_split, load_cora, load_karate, load_ogb, prepare_data
...
if __name__ == '__main__':
	...
	argparser.add_argument('--batch-size', type=int, default=14000)
